...
class ArtistSettingView extends StatefulWidget {
  const ArtistSettingView({
    this.artistName,
  ...
  @override
  State<ArtistSettingView> createState() => _ArtistSettingViewState();
}

class _ArtistSettingViewState extends State<ArtistSettingView> {
  late ArtFraming selectedFitment;
  late FFBluetoothDevice? connectedDevice;
